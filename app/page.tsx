...
export default async function Home() {
  return (
    <div className="overflow-x-hidden">
      ...
      <section
        id="home"
        className="relative pt-32 pb-16 md:pt-40 md:pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto"
      >
          ...
          <div className="flex flex-col gap-6 lg:col-span-7 text-center lg:text-left z-10">
            ...
            <div className="space-y-3">
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight text-slate-900 leading-tight">
                Government Model <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-950 to-indigo-700">
                  High School
                </span>
              </h1>
            ...
            <p className="text-slate-600 text-base md:text-lg max-w-xl mx-auto lg:mx-0 leading-relaxed">
              Igniting a passion for lifelong learning, empowering students to
              think critically, and preparing them for a successful, inclusive
          ...
          <div className="lg:col-span-5 relative w-full flex justify-center lg:justify-end">
            <div className="relative w-full max-w-[420px] aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl group border-4 border-white animate-float">
              ...
              <div className="absolute bottom-6 left-6 right-6 z-25 text-left text-white">
                <span className="bg-amber-500 text-slate-900 text-[10px] font-bold uppercase px-2 py-0.5 rounded-full tracking-wider">
                  Campus View
                </span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 items-center">
            ...
            <div className="lg:col-span-8 flex flex-col gap-5 text-left">
              ...
              <div className="text-slate-650 text-xs md:text-sm leading-relaxed font-medium">
                <p>
                  Our school is a sought after school not only because of its
                  sprawling campus and but also because it offers courses in all
                  language i.e English, Hindi, Punjabi. It is a building with
                  four walls but has a tomorrow inside. Our focus is ‘the child’
                  i.e we aim at imparting child centred education. We keep
                  organising both academic and non-academic activities to teach
                  all aspects of the education and develop the child physically,
                  mentally, emotionally and socially. We aim at inculcating
                  values of honesty, kindness etc as they are going to be the
                  future citizens. Our motto is that every child should reach
                  the level of excellence, he/she is capable of and the teachers
                  act as their guide in this pursuit. In partnership with family
                  and community, we engage students, to become informed,
                  compassionate global citizens. Our aim is to make them learn
                  to do their best, work for others and be safe and kind. We
                  have an SMC (school management committee), Sexual Harassment
                  Committee and Student Grievance Redressal Forum for better
                  functioning of the school. We believe in “Think of no future
                  however bright Let the dead past bury its dead. Act Act Act in
                  the living present. Heart within and God overhead.“
                </p>
              </div>

              <div className="flex items-center justify-between pt-4 border-t border-slate-100 mt-2">
                <span className="text-xs text-slate-400 font-semibold">
                  GMHS Pocket 1 Academic Portal
                </span>
        ...
        <div className="glass-panel border-slate-200/60 bg-white/95 rounded-3xl p-8 md:p-12 shadow-md relative overflow-hidden text-center">
          ...
          <div className="max-w-2xl mx-auto space-y-4">
            ...
            <blockquote className="text-slate-700 text-lg sm:text-xl md:text-2xl font-extrabold italic leading-relaxed">
              &ldquo;Our mission is to ignite a passion for lifelong learning,
              empower students to think critically, and prepare them for a
              successful future.&rdquo;
            </blockquote>
          </div>
        </div>
      </section>
